                        ...
                        <div class="card">
                            <form method="POST" action="{{ route('companies.update', $company->id) }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="string" step="0.01" name="radius_km" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="text" name="latitide" class="form-control"
                                                value="{{ $company->latitide }}">
                                        </div>
                                        <div class="form-group col-md-6 col-12">
                                            <label>Longitude</label>
                                            <input type="text" name="lognitude" class="form-control"
                                                value="{{ $company->lognitude }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="{{ route('companies.show', 1) }}" class="btn btn-warning">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
